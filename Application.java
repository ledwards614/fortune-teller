...
public class Application {
	public static void main(String[] args) {
		...
		System.out.println("*" + firstName + "* *" + lastName + "* *" + colorFortune(color) + "* *"
				+ monthFortune(month) + "* *" + siblingFortune(siblings) + "* *" + ageFortune(age) + "*");
	...
	private static String ageFortune(int age) {
		String ageStr = null;
		if (age % 2 == 0) { // even will have remainder (%) of zero if divided
							// by 2
